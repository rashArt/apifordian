...
class UpdatePayrollTypeDocumentIdentificationsTable extends Migration
{
	...
	public function up()
	{
        ...
        PayrollTypeDocumentIdentification::create(['name' => 'PEP (Permiso Especial de Permanencia)', 'code' => '47']);
        PayrollTypeDocumentIdentification::where('code', '47')->update(['id' => 9, 'name' => 'PEP (Permiso Especial de Permanencia)', 'code' => '47']);
        PayrollTypeDocumentIdentification::create(['name' => 'PPT (Permiso Protección Temporal)', 'code' => '48']);

...
<Invoice
	...
	<cac:DeliveryTerms>
		<cbc:SpecialTerms>{{preg_replace("/[\r\n|\n|\r]+/", "", $deliveryterms->special_terms)}}</cbc:SpecialTerms>
		<cbc:LossRiskResponsibilityCode>{{preg_replace("/[\r\n|\n|\r]+/", "", $deliveryterms->loss_risk_responsibility_code)}}</cbc:LossRiskResponsibilityCode>
		<cbc:LossRisk>{{preg_replace("/[\r\n|\n|\r]+/", "", $deliveryterms->loss_risk)}}</cbc:LossRisk>
	</cac:DeliveryTerms>
    {{-- Delivery --}}
    @isset($delivery)
